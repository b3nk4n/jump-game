...
/**
 * A simple service managing the interstitial ads for this game.
 ...
 */
public class InterstitialAdMobService implements AdService {

    private static final Logger LOG = new Logger(InterstitialAdMobService.class.getSimpleName(), Cfg.LOG_LEVEL);
    ...
    public InterstitialAdMobService(Activity activity, final String adUnitId, boolean debug, String testDeviceHashedId) {
        this.activity = activity;
        this.debug = debug;
        this.testDeviceHashedId = testDeviceHashedId;

        this.adUnitId = debug
                ? Ads.TEST_INTERSTITIAL_AD_UNIT_ID
                : adUnitId;
    }
    ...
    public boolean isReady() {
        return interstitialAd != null && consentInformation.canRequestAds();
    }
